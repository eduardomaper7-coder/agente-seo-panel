...
// Contenido de la página "Resumen" — lo usan tanto el panel del cliente
// (/dashboard) como el panel interno cuando un administrador ve el panel de
// un cliente concreto (/admin/clientes/[id]). basePath decide a dónde
      ...
      <Card>
        <CardBody>
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href={`${basePath}/palabras-clave`} className="flex items-center gap-1 text-xs font-medium text-accent hover:underline">
